...
class TreeTest(unittest.TestCase):
    ...
    def test_add_node(self):
        ...
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4])
        bst.AddKeyValue(6, 'right')
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 6])
        ...
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12])
        self.assertEqual(root.RightChild.NodeKey, 12)
        bst.AddKeyValue(14, 'right')
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12, 14])
        ...
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12, 14, 15])
        ...
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12, 10, 14, 15])
        ...
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12, 10, 9, 14, 15])
        self.assertEqual(root.RightChild.LeftChild.LeftChild.NodeKey, 9)
        self.assertEqual(root.RightChild.LeftChild.RightChild, None)
        bst.AddKeyValue(11, 'right')
        self.assertListEqual([i.NodeKey for i in bst.pre_order(root)], [8, 4, 2, 6, 12, 10, 9, 11, 14, 15])
        self.assertEqual(root.RightChild.LeftChild.LeftChild.NodeKey, 9)
        self.assertEqual(root.RightChild.LeftChild.RightChild.NodeKey, 11)
        print([i.NodeKey for i in bst.pre_order(root)])
